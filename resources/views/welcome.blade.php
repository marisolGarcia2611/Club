...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        ...
        <p id='head1' class='header'><img  width="350" height="350" src="{{ asset('icons/10.png') }}" alt="login__body "/></p>
        ...
        <p id='head5' class='header'><img   width="500" height="500" src="{{ asset('images/logo.png') }}" alt="login__body "/></p>
