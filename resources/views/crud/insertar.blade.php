        ...
        <div class="shadow p-3 mb-5 bg-body rounded">
            ...
            <div class="container p-5">
                <div class="row text-center">
                    <h3 class="fw-light">Ejemplo Insertar</h3>
                </div>
                <form action="" method="POST" enctype="multipart/form-data" class="g-3 form needs-validation" novalidate>
                    ...
                    <div class="mb-4 text-center">
                        <button type="submit" class="btn btn-blue col-md-2 col fw-light rounded-5 fs-6_5"><i class="fas fa-save"></i>&nbsp;&nbsp; Guardar</button></br></br>
                    </div>
                </form>
            </div>
        </div>   
